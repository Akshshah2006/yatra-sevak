...
english_trans = {
    'title': '🛕 Yatra Sevak: Multi-Temple Management',
...
TRANSLATIONS = {
    ...
    'Gujarati': {
        **english_trans,
        'title': '🛕 યાત્રા સેવક: મલ્ટી-મંદિર વ્યવસ્થાપન ',
        'select_temple': 'મંદિર પસંદ કરો',
        'home_info': 'ઘર અને મંદિર માહિતી ',
        'join_queue': 'સ્માર્ટ કતાર અને ટિકિટિંગ ',
        'sos_nav': 'ઇમરજન્સી અને સુરક્ષા ',
        'surveillance': 'IoT અને સર્વેલન્સ ',
        'traffic': 'ટ્રાફિક અને મોબિલિટી ',
        'accessibility': 'પહોંચવાની સુવિધાઓ ',
        'prediction': 'AI ભીડ અનુમાન ',
        'pilgrim_app': 'તીર્થયાત્રી વ્યૂ',
        'authority_dashboard': 'અધિકારી ડેશબોર્ડ',
        'language': 'ભાષા / ભાષા / भाषा',
        'view_as': 'જોવા માટે',
        'temple_info_wait': 'એન્ગેજમેન્ટ: સમય, માર્ગ, સુવિધાઓ ',
        'current_weather': 'હવામાન : 28°C (સિમ). નીચે માર્ગો.',
        'virtual_darshan': 'વર્ચ્યુઅલ કતાર વ્યવસ્થાપન ',
        'elderly_priority': 'વૃદ્ધ/અપંગ માટે પ્રાયોરિટી ',
        ...
        'medical_map': 'મેડિકલ મેપિંગ ',
        'barricades': 'સ્માર્ટ બેરિકેડ્સ ',
    ...
    'Hindi': {
        **english_trans,
        'title': '🛕 यात्रा सेवक: मल्टी-मंदिर प्रबंधन ',
        'select_temple': 'मंदिर चुनें',
        'home_info': 'घर और मंदिर जानकारी ',
        'join_queue': 'स्मार्ट कतार और टिकटिंग ',
        'sos_nav': 'आपातकालीन और सुरक्षा ',
        'surveillance': 'IoT और निगरानी ',
        'traffic': 'ट्रैफिक और मोबिलिटी ',
        'accessibility': 'पहुंच सुविधाएं ',
        'prediction': 'AI भीड़ पूर्वानुमान ',
        'pilgrim_app': 'तीर्थयात्री व्यू',
        'authority_dashboard': 'प्राधिकरण डैशबोर्ड',
        'language': 'भाषा / ભાષા / भाषा',
        'view_as': 'देखें के रूप में',
        'temple_info_wait': 'एंगेजमेंट: समय, मार्ग, सुविधाएं ',
        'current_weather': 'मौसम : 28°C (सिम). नीचे मार्ग.',
        'virtual_darshan': 'वर्चुअल कतार प्रबंधन ',
        'elderly_priority': 'वृद्ध/अपंग के लिए प्राथमिकता ',
        ...
        'medical_map': 'मेडिकल मैपिंग ',
        'barricades': 'स्मार्ट बैरिकेड्स ',
...
if role == t['pilgrim_app']:
    ...
    with tabs[5]:  # #6 - Pilgrim Engagement Platforms
        st.markdown(f"<div class='section-header'>Pilgrim Engagement </div>", unsafe_allow_html=True)
        col1, col2, col3 = st.columns(3)
        q_df = pd.DataFrame([q for q in st.session_state.queue_data if q.get('temple') == temple])
    ...
    with tabs[6]:  # #7 - Accessibility Features
        ...
        if st.button("Broadcast Voice Navigation "):
            st.success("Voice Guide Broadcasted to Devices ")
            st.info(t['audio_sim'])
    ...
    with tabs[7]:  # #4 - Emergency & Safety Solutions (Authority View)
        ...
        st.info("Monitor SOS Alerts and Dispatch ")
